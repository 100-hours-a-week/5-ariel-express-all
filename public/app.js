...
// 게시글 목록 조회 페이지
app.get('/list-of-posts', isLoggedIn, (req, res) => {
...
// 게시글 상세 조회 페이지
app.get('/post-details', isLoggedIn, (req, res) => {
    res.sendFile(path.join(publicPath, 'html', 'post-details.html'));
});

// 게시글 수정 페이지
app.get('/update-post', isLoggedIn, (req, res) => {
...
// 비밀번호 수정 페이지
app.get('/update-password', isLoggedIn, (req, res) => {
